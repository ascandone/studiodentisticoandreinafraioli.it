...
const Landing: FunctionComponent = () => {
  const data = useStaticQuery(graphql`
    query {
      file(relativePath: { eq: "landing-pic.png" }) {
        childImageSharp {
  ...
  return (
    <Section>
      <div className="flex flex-col justify-center md:flex-row">
        <div className="flex-1 md:mr-16 lg:mr-24">
          <div className="flex flex-col h-full justify-center">
            ...
            <div className="flex flex-col items-center sm:flex-row-reverse justify-end">
              ...
              <button className="btn shadow-lg shadow-md bg-teal-400 text-white transition-all duration-300 hover:shadow-xl">
                Contattaci
              </button>
            </div>
          </div>
        ...
        <div className="self-center mt-5 flex-1 w-full max-w-xs md:max-w-full">
          <Img
